# SQL CTE Exercises - Solutions (Flight Data)

Complete solutions for flight data exercises using Mode's `tutorial.us_flights` and `tutorial.flights` tables.
...
### Exercise 7: Simple Number Sequence (Recursive)
...
### Exercise 8: Distance Ranges with Window Functions
...
### Challenge 2: Route Profitability Analysis
...
Good luck with your SQL journey! These exercises cover industry patterns you'll see daily. 🚀
